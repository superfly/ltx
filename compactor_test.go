...
func TestCompactor_Compact(t *testing.T) {
	...
	t.Run("SnapshotPageDataOnly", func(t *testing.T) {
		spec, err := compactFileSpecs(t, ltx.NewCompactor(),
			&ltx.FileSpec{
				Header: ltx.HeaderFrame{Version: 1, PageSize: 1024, PageFrameN: 3, Commit: 3, DBID: 1, MinTXID: 1, MaxTXID: 1, Timestamp: 1000},
				PageHeaders: []ltx.PageFrameHeader{
					{Pgno: 1},
					{Pgno: 2},
					{Pgno: 3},
			...
			&ltx.FileSpec{
				Header: ltx.HeaderFrame{Version: 1, PageSize: 1024, PageFrameN: 2, Commit: 3, DBID: 1, MinTXID: 2, MaxTXID: 2, Timestamp: 2000},
				PageHeaders: []ltx.PageFrameHeader{
					{Pgno: 1},
					{Pgno: 3},
				},
		...
		assertFileSpecEqual(t, spec, &ltx.FileSpec{
			Header: ltx.HeaderFrame{Version: 1, PageSize: 1024, PageFrameN: 3, Commit: 3, DBID: 1, MinTXID: 1, MaxTXID: 2, Timestamp: 1000},
			PageHeaders: []ltx.PageFrameHeader{
				{Pgno: 1},
				{Pgno: 2},
				{Pgno: 3},
	...
	t.Run("NonSnapshotPageDataOnly", func(t *testing.T) {
		spec, err := compactFileSpecs(t, ltx.NewCompactor(),
			&ltx.FileSpec{
				Header: ltx.HeaderFrame{Version: 1, PageSize: 1024, PageFrameN: 1, Commit: 3, DBID: 1, MinTXID: 2, MaxTXID: 3, Timestamp: 1000},
				PageHeaders: []ltx.PageFrameHeader{
					{Pgno: 3},
				},
				PageData: [][]byte{
			...
			&ltx.FileSpec{
				Header: ltx.HeaderFrame{Version: 1, PageSize: 1024, PageFrameN: 1, Commit: 3, DBID: 1, MinTXID: 4, MaxTXID: 5, Timestamp: 2000},
				PageHeaders: []ltx.PageFrameHeader{
					{Pgno: 1},
				},
				PageData: [][]byte{
			...
			&ltx.FileSpec{
				Header: ltx.HeaderFrame{Version: 1, PageSize: 1024, PageFrameN: 3, Commit: 5, DBID: 1, MinTXID: 6, MaxTXID: 9, Timestamp: 3000},
				PageHeaders: []ltx.PageFrameHeader{
					{Pgno: 2},
					{Pgno: 3},
					{Pgno: 5},
		...
		assertFileSpecEqual(t, spec, &ltx.FileSpec{
			Header: ltx.HeaderFrame{Version: 1, PageSize: 1024, PageFrameN: 4, Commit: 5, DBID: 1, MinTXID: 2, MaxTXID: 9, Timestamp: 1000},
			PageHeaders: []ltx.PageFrameHeader{
				{Pgno: 1},
				{Pgno: 2},
				{Pgno: 3},
	...
	t.Run("MultiFileWithPageAndEventData", func(t *testing.T) {
		spec, err := compactFileSpecs(t, ltx.NewCompactor(),
			&ltx.FileSpec{
				Header: ltx.HeaderFrame{Version: 1, PageSize: 1024, PageFrameN: 1, EventFrameN: 2, EventDataSize: 130, Commit: 1, DBID: 1, MinTXID: 1, MaxTXID: 1, Timestamp: 1000},
				PageHeaders: []ltx.PageFrameHeader{
					{Pgno: 1},
				},
				PageData: [][]byte{
			...
			&ltx.FileSpec{
				Header: ltx.HeaderFrame{Version: 1, PageSize: 1024, PageFrameN: 1, Commit: 1, DBID: 1, MinTXID: 2, MaxTXID: 2, Timestamp: 2000},
				PageHeaders: []ltx.PageFrameHeader{
					{Pgno: 1},
				},
				PageData: [][]byte{
			...
			&ltx.FileSpec{
				Header: ltx.HeaderFrame{Version: 1, PageSize: 1024, PageFrameN: 1, EventFrameN: 1, EventDataSize: 80, Commit: 1, DBID: 1, MinTXID: 3, MaxTXID: 3, Timestamp: 3000},
				PageHeaders: []ltx.PageFrameHeader{
					{Pgno: 1},
				},
				PageData: [][]byte{
		...
		assertFileSpecEqual(t, spec, &ltx.FileSpec{
			Header: ltx.HeaderFrame{Version: 1, PageSize: 1024, PageFrameN: 1, EventFrameN: 3, EventDataSize: 210, Commit: 1, DBID: 1, MinTXID: 1, MaxTXID: 3, Timestamp: 1000},
			PageHeaders: []ltx.PageFrameHeader{
				{Pgno: 1},
			},
			PageData: [][]byte{
	...
	t.Run("ErrDBIDMismatch", func(t *testing.T) {
		_, err := compactFileSpecs(t, ltx.NewCompactor(),
			&ltx.FileSpec{
				Header:      ltx.HeaderFrame{Version: 1, PageSize: 1024, PageFrameN: 1, Commit: 1, DBID: 1, MinTXID: 1, MaxTXID: 1, Timestamp: 1000},
				PageHeaders: []ltx.PageFrameHeader{{Pgno: 1}},
				PageData:    [][]byte{bytes.Repeat([]byte{0x81}, 1024)},
			},
			&ltx.FileSpec{
				Header:      ltx.HeaderFrame{Version: 1, PageSize: 1024, PageFrameN: 1, Commit: 1, DBID: 2, MinTXID: 1, MaxTXID: 1, Timestamp: 1000},
				PageHeaders: []ltx.PageFrameHeader{{Pgno: 1}},
	...
	t.Run("ErrPageSizeMismatch", func(t *testing.T) {
		_, err := compactFileSpecs(t, ltx.NewCompactor(),
			&ltx.FileSpec{
				Header:      ltx.HeaderFrame{Version: 1, PageSize: 512, PageFrameN: 1, Commit: 1, DBID: 1, MinTXID: 1, MaxTXID: 1, Timestamp: 1000},
				PageHeaders: []ltx.PageFrameHeader{{Pgno: 1}},
	...
	t.Run("ErrNonContiguousTXID", func(t *testing.T) {
		_, err := compactFileSpecs(t, ltx.NewCompactor(),
			&ltx.FileSpec{
				Header:      ltx.HeaderFrame{Version: 1, PageSize: 1024, PageFrameN: 1, Commit: 1, DBID: 1, MinTXID: 1, MaxTXID: 2, Timestamp: 1000},
				PageHeaders: []ltx.PageFrameHeader{{Pgno: 1}},
				PageData:    [][]byte{bytes.Repeat([]byte{0x81}, 1024)},
			},
			&ltx.FileSpec{
				Header:      ltx.HeaderFrame{Version: 1, PageSize: 1024, PageFrameN: 1, Commit: 1, DBID: 1, MinTXID: 2, MaxTXID: 2, Timestamp: 1000},
				PageHeaders: []ltx.PageFrameHeader{{Pgno: 1}},
				PageData:    [][]byte{bytes.Repeat([]byte{0x91}, 1024)},
			},
		)
